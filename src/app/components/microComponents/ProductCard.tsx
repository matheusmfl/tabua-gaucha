...
export function ProductCard({ imageUrl, altImage, description, price, key }: productCard) {
  ...
  return (
    <div className="w-full flex flex-col md:w-[350px] cursor-pointer hover:cursor-pointer" key={key}>
      {/* div Img */}
      ...
      <div className="py-[10px] px-[10px] flex justify-between gap-[10px] lg:pb-6 bg-white shadow-xl">
